...
cmd({
    ...
    try {
        ...
        const searchResponse = await axios.get(`https://darksadas-yt-fire-last-dl.vercel.app/scrape?url=https://firemovieshub.com/links/c8akvteyh8/`);
